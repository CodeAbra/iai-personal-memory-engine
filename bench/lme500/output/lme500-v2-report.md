...
- Source: `bench/lme500/output/lme500-v2.json`
- n = 500, errors = 0
...
| Y (recall_for_benchmark — full graph-native pipeline) | 0.956 | [0.938, 0.974] | 0.976 | [0.962, 0.988] |
...
|---|---|---|---|---|---|---|---|
| `knowledge-update` | 78 | 0.974 | 0.974 | +0.000 | 0.987 | 0.987 | +0.000 |
| `multi-session` | 133 | 0.970 | 0.970 | +0.000 | 0.985 | 0.985 | +0.000 |
| `single-session-assistant` | 56 | 1.000 | 1.000 | +0.000 | 1.000 | 1.000 | +0.000 |
| `single-session-preference` | 30 | 0.900 | 0.900 | +0.000 | 0.933 | 0.933 | +0.000 |
| `single-session-user` | 70 | 0.957 | 0.957 | +0.000 | 0.986 | 0.986 | +0.000 |
| `temporal-reasoning` | 133 | 0.925 | 0.925 | +0.000 | 0.955 | 0.955 | +0.000 |
