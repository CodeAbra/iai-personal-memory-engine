...
**Run ID:** 20260519T184522Z-ce982f4-seeds13-42-137-scale_honest
**Duration:** 8283.4s
...
| `wall_clock_start_utc` | 2026-05-19T18:45:22.361986+00:00 |
| `scale` | honest |
| `n_sessions` | 1000 |
| `n_probes_pre` | 250 |
| `n_probes_post` | 250 |
...
| `floor_mode` | relaxed |
| `wall_clock_duration_seconds` | 8283.43 |
