...
**Run ID:** 20260519T144105Z-1caabe7-seeds13-42-137-scale_honest
**Duration:** 8388.0s
...
| `wall_clock_start_utc` | 2026-05-19T14:41:05.627763+00:00 |
| `scale` | honest |
| `n_sessions` | 1000 |
| `n_probes_pre` | 250 |
| `n_probes_post` | 250 |
...
| `floor_mode` | relaxed |
| `wall_clock_duration_seconds` | 8388.05 |
