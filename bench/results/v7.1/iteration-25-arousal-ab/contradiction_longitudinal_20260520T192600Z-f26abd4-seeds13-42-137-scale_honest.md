...
**Run ID:** 20260520T192600Z-f26abd4-seeds13-42-137-scale_honest
**Duration:** 1556.7s
...
| `wall_clock_start_utc` | 2026-05-20T19:26:00.801665+00:00 |
| `scale` | honest |
| `n_sessions` | 1000 |
| `n_probes_pre` | 250 |
| `n_probes_post` | 250 |
...
| `floor_mode` | relaxed |
| `wall_clock_duration_seconds` | 1556.7 |

## Cross-seed (B robustness)

| N slice | ΔMRR mean | stdev | min | max | robust? |
|---|---|---|---|---|---|
| n_0 | -0.0331 | 0.0058 | -0.0398 | -0.0294 | NO |
| n_1 | -0.0197 | 0.0172 | -0.0320 | 0.0000 | NO |

## Per-cell detail

| seed | N | A hit@k (pipe / cos) | A floor | B-class ΔMRR (CI) | B-contract hint% / anti-hits% | gate A | gate B-class | gate B-contract |
|---|---|---|---|---|---|---|---|---|
| 13 | 0 | 0.000 / 0.000 | 0 | -0.0398 (-0.0575, -0.0221) | 1.000 / 0.000 | FAIL | FAIL | PASS |
| 13 | 1 | 0.000 / 0.000 | 0 | 0.0000 (0.0000, 0.0000) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
| 42 | 0 | 0.000 / 0.000 | 0 | -0.0294 (-0.0882, 0.0000) | 1.000 / 0.000 | FAIL | FAIL | PASS |
| 42 | 1 | 0.000 / 0.000 | 0 | -0.0271 (-0.0465, -0.0078) | 1.000 / 0.000 | FAIL | FAIL | PASS |
| 137 | 0 | 0.000 / 0.000 | 0 | -0.0300 (-0.0500, -0.0133) | 1.000 / 0.000 | FAIL | FAIL | PASS |
| 137 | 1 | 1.000 / 1.000 | 0 | -0.0320 (-0.0480, -0.0180) | 1.000 / 0.000 | PASS | FAIL | PASS |
