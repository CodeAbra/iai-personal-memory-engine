...
**Run ID:** 20260519T143832Z-f425aeb-seeds13-42-137-scale_smoke
**Duration:** 10.3s
...
| `wall_clock_start_utc` | 2026-05-19T14:38:32.428301+00:00 |
| `scale` | smoke |
| `n_sessions` | 4 |
| `n_probes_pre` | 2 |
| `n_probes_post` | 2 |
...
| `floor_mode` | relaxed |
| `wall_clock_duration_seconds` | 10.26 |

## Cross-seed (B robustness)

| N slice | ΔMRR mean | stdev | min | max | robust? |
|---|---|---|---|---|---|
| n_0 | 0.1667 | 0.2887 | 0.0000 | 0.5000 | NO |
| n_1 | 0.1667 | 0.2887 | 0.0000 | 0.5000 | NO |

## Per-cell detail

| seed | N | A hit@k (pipe / cos) | A floor | B-class ΔMRR (CI) | B-contract hint% / anti-hits% | gate A | gate B-class | gate B-contract |
|---|---|---|---|---|---|---|---|---|
| 13 | 0 | 1.000 / 1.000 | 0 | 0.5000 (0.5000, 0.5000) | 1.000 / 0.000 | PASS | PASS | PASS |
| 13 | 1 | 1.000 / 1.000 | 0 | 0.5000 (0.5000, 0.5000) | 1.000 / 0.000 | PASS | PASS | PASS |
