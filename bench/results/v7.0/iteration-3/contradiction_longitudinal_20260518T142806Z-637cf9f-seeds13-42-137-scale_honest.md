...
**Run ID:** 20260518T142806Z-637cf9f-seeds13-42-137-scale_honest
**Duration:** 10683.2s
...
| `seed_list` | [13, 42, 137] |
| `iai_mcp_store` | /private/tmp/iai-mcp-bench-claude/v7.0-store-i3 |
| `wall_clock_start_utc` | 2026-05-18T14:28:06.879030+00:00 |
| `scale` | honest |
| `n_sessions` | 1000 |
| `n_probes_pre` | 250 |
| `n_probes_post` | 250 |
...
| `floor_mode` | relaxed |
| `wall_clock_duration_seconds` | 10683.17 |
