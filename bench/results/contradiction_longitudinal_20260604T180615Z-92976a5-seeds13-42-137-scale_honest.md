...
**Run ID:** 20260604T180615Z-92976a5-seeds13-42-137-scale_honest
**Duration:** 556.3s
...
| `wall_clock_start_utc` | 2026-06-04T18:06:15.297299+00:00 |
| `scale` | honest |
| `n_sessions` | 1000 |
| `n_probes_pre` | 250 |
| `n_probes_post` | 250 |
...
| `floor_mode` | relaxed |
| `wall_clock_duration_seconds` | 556.35 |
...
|---|---|---|---|---|---|---|---|---|
| 13 | 0 | 0.692 / 0.692 | 77 | -0.0400 (-0.0580, -0.0240) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
| 13 | 1 | 0.692 / 0.692 | 77 | -0.0400 (-0.0580, -0.0240) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
| 42 | 0 | 0.708 / 0.708 | 73 | -0.0340 (-0.0500, -0.0200) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
| 42 | 1 | 0.708 / 0.708 | 73 | -0.0340 (-0.0500, -0.0200) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
| 137 | 0 | 0.740 / 0.740 | 65 | -0.0320 (-0.0480, -0.0180) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
| 137 | 1 | 0.740 / 0.740 | 65 | -0.0320 (-0.0480, -0.0180) | 0.000 / 0.000 | FAIL | FAIL | FAIL |
...
- **Metric B-classical (rank current above cosine)** tests an expectation that does NOT appear in any design doc. By design the system uses dual-route + inhibitory edges + hints, not rerank. Expect ΔMRR ≈ 0; this is a feature, not a bug.
