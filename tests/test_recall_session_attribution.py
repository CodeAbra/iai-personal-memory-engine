...
def test_recall_hit_carries_session_id_and_captured_at(tmp_path):
    ...
    result = capture_turn(
        store,
        cue="known user line turnmark59",
        text="known user line turnmark59 distinctive text",
        tier="episodic",
        session_id="sess-A1-turnmark59",
        role="user",
    )
    ...
    assert top.get("session_id") == "sess-A1-turnmark59", (
